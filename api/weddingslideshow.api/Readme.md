...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *weddingslideshow.api*):

Restore dependencies
```
    cd "weddingslideshow.api"
    dotnet restore
```

Execute unit tests
```
    cd "weddingslideshow.api/test/weddingslideshow.api.Tests"
    dotnet test
```

Deploy application
```
    cd "weddingslideshow.api/src/weddingslideshow.api"
